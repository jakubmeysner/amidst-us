        ...
        if (args.size != 1) {
            ...
            if (bukkitPlayer == null) {
                ...
                if (game == null) {
                    ...
                    sender.spigot().sendMessage(
                        *ComponentBuilder("This player has already been invited to this game!").color(ChatColor.RED)
                            .create()
                    )
                } else {
                    ...
                    if (!senderPlayer.promoted) {
                        ...
                        sender.spigot().sendMessage(
                            *ComponentBuilder("Can't invite any more players to this game!").color(ChatColor.RED)
                                .create()
                        )
                    } else {
